...
| Live sync progress (2026-08-12 ~16:30 CEST) | Headers+Bodies+**SenderRecovery** = Tip **173 369 140** (Sender ~12.9 h). **Execution ~6.5 M (~3.7 %)**, Block-ETA ~**24–26 h** (entities-lag → konservativ länger). Next gates FLOW-X01 (Fermat) / FLOW-X02 (Wright L1-Fee). Details: `plan.md` § Live Sync Progress. |
