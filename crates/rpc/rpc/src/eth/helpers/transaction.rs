...
use reth_transaction_pool::{
    ...
    EthPoolTransaction, PoolPooledTx, PoolTransaction, PoolTx, TransactionOrigin, TransactionPool,
};
    ...
    Rpc: RpcConvert<Primitives = N::Primitives, Error = EthApiError>,
{
    ...
    async fn send_transaction(
        ...
        self.send_pool_transaction(origin, WithEncoded::new(tx, pool_transaction)).await
    }
