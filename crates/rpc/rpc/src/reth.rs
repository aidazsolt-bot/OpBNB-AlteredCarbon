...
use alloy_primitives::{map::AddressMap, Address, U256, U64};
use async_trait::async_trait;
use futures::{Stream, StreamExt};
use jsonrpsee::{core::RpcResult, PendingSubscriptionSink, SubscriptionMessage, SubscriptionSink};
use reth_chain_state::{
    CanonStateNotification, CanonStateNotificationStream, CanonStateSubscriptions,
    ForkChoiceStream, ForkChoiceSubscriptions, PersistedBlockSubscriptions,
};
...
async fn finalized_chain_notifications<N>(
    ...
    mut canon_stream: CanonStateNotificationStream<N>,
    mut finalized_stream: ForkChoiceStream<SealedHeader<N::BlockHeader>>,
) where
    N: NodePrimitives,
{
