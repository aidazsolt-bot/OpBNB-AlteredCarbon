...
mod test {
    ...
    const MULTI_ADDRESSES: &str = "/ip4/<ipv4>/udp/30301/p2p/16Uiu2HAmSG2hdLwyQHQmG4bcJBgD64xnW63WMTLcrNq6KoZREfGb,/ip4/<ipv4>/udp/30301/p2p/16Uiu2HAmMy4V8bi3XP7KDfSLQcLACSvTLroRRwEsTyFUKo8NCkkp,/ip4/<ipv4>/udp/30301/p2p/16Uiu2HAmSVsb7MbRf1jg3Dvd6a3n5YNqKQwn1fqHCFgnbqCsFZKe,/ip4/<ipv4>/udp/30301/p2p/16Uiu2HAm74pBDGdQ84XCZK27GRQbGFFwQ7RsSqsPwcGmCR3Cwn3B,/ip4/<ipv4>/udp/30301/p2p/16Uiu2HAmMnTiJwgFtSVGV14ZNpwAvS1LUoF4pWWeNtURuV6C3zYB";
    ...
    fn parse_boot_nodes() {
        ...
        let socket_1 = "<ipv4>:9222".parse::<SocketAddrV4>().unwrap();
        let socket_2 = "<ipv4>:9222".parse::<SocketAddrV4>().unwrap();
    ...
    fn overwrite_ipv4_addr() {
        let rlpx_addr: Ipv4Addr = "<ipv4>".parse().unwrap();
    ...
    fn overwrite_ipv6_addr() {
        let rlpx_addr: Ipv6Addr = "fe80<ipv6>".parse().unwrap();
