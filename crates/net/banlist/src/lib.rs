...
mod ip_filter_tests {
    ...
    #[test]
    fn test_ipv6_filter() {
        let filter = IpFilter::from_cidr_string("<ipv6>/32").unwrap();
        let ipv6_in_range: IpAddr = "<ipv6><ipv6>".parse().unwrap();
        let ipv6_out_range: IpAddr = "<ipv6><ipv6>".parse().unwrap();
    ...
    fn test_mixed_ipv4_ipv6_filter() {
        let filter = IpFilter::from_cidr_string("192.168.0.0/16,<ipv6>/32").unwrap();
    ...
    fn test_single_ip_as_cidr() {
        let filter = IpFilter::from_cidr_string("<ipv4>/32").unwrap();
