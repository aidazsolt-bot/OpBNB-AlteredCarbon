...
mod tests {
    ...
    #[test]
    fn test_url_parse() {
        let url = "enode://6f8a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@<ipv4>:30303?discport=30301";
        let node: NodeRecord = url.parse().unwrap();
        assert_eq!(node, NodeRecord {
    ...
    fn test_node_display() {
        let url = "enode://6f8a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@<ipv4>:30303";
        let node: NodeRecord = url.parse().unwrap();
    ...
    fn test_node_serialize() {
        let cases = vec![
            ...
            (
                ...
                "\"enode://6f8a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@<ipv4>:30303?discport=30301\""
            ),
            // IPv6
            (
                NodeRecord {
                ...
                "\"enode://1dd9d65c4552b5eb43d5ad55a2ee3f56c6cbc1c64a5c8d659f51fcd51bace24351232b8d7821617d2b29b54b81cdefb9b3e9c37d7fd5f63270bcc9e1a6f6a439@[<ipv6>]:52150?discport=52151\"",
            )
        ];
    ...
    fn tcp_less_enr_converts_with_port_zero() {
        ...
        let enr = Enr::builder().ip4("<ipv4>".parse().unwrap()).udp4(30301).build(&sk).unwrap();
