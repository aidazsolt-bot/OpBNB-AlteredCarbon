...
pub struct L1BlockInfo {
    ...
    /// Whether the active chain fork waives L1 data fees for gasless transactions.
    pub skip_l1_data_fee: bool,
}
...
mod tests {
    ...
    #[test]
    fn wright_gasless_transactions_skip_only_l1_data_fee() {
        ...
        let info = || L1BlockInfo {
            ...
            operator_fee_constant: Some(U256::from(10)),
        ...
        assert!(
            ...
            "Wright must retain L1 data fees for priced transactions"
        );
    }
}
