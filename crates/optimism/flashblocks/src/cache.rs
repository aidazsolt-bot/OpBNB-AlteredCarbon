...
#[derive(Debug)]
struct PendingSequence<T: SignedTransaction + SignerRecoverable> {
...
impl<T: SignedTransaction + SignerRecoverable> PendingSequence<T> {
    fn new() -> Self {
        Self {
...
#[derive(Debug)]
pub(crate) struct SequenceManager<T: SignedTransaction + SignerRecoverable> {
...
impl<T: SignedTransaction + SignerRecoverable> SequenceManager<T> {
