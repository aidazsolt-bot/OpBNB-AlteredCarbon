use alloy_consensus::{
    BlobTransactionSidecar, EnvKzgSettings, EthereumTxEnvelope, SidecarBuilder, SimpleCoder,
...
impl TransactionTestContext {
    ...
    pub async fn tx_with_blobs(
        ...
        tx.set_blob_sidecar(BlobTransactionSidecarVariant::Eip4844(
            builder.build::<BlobTransactionSidecar>()?,
        ));
