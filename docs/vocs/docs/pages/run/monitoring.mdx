...
To run Jaeger locally, follow the [Jaeger setup docs](https://www.jaegertracing.io/docs/2.11/getting-started/)
(native binary or your own process manager — this fork does not ship Docker run recipes).
Aim for OTLP on port `4318` / gRPC `4317` and the UI on `16686`.
